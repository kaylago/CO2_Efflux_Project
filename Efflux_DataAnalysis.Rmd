...
plot<-ggplot(data,aes(x=tide,y=mean.flux,color=location))+
  ...
  scale_color_manual(name="Beach",labels=c("EAFB-CSB","Salinas","Rish"),values=c("steelblue3","darkolivegreen4","coral"))+
  theme_bw()+
  theme(text=element_text(size=15,color="black",family="Calibri"),axis.text = element_text(color="black",size=14,family="Calibri"),axis.text.x = element_text(angle=45,hjust=1))+
...
boxplot_sig <- ggplot(subset(total.data,zone!="littoral"),aes(x=location,y=efflux))+
  ...
  scale_x_discrete(name="Beach",labels=c("EAFB-CSB", "Rish","Salinas"))+
  theme(panel.grid.minor = element_blank(),panel.grid.major = element_blank(),panel.border = element_blank(),axis.line = element_line(color="black"))+
  geom_segment(data=annotation_df1,aes(x="EAFB",xend="EAFB",y=1.5,yend=2))+
  geom_segment(data=annotation_df1,aes(x="EAFB",xend="Salinas",y=2,yend=2))+
  geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=2,yend=1.5))+
   annotate("text",x = c(2),y = c(2.2),label = c("p = 0.029"),family = "", fontface = 3, size=4)+
   geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="SJP-Rish",y=3,yend=3.5))+
  geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="Salinas",y=3.5,yend=3.5))+
  geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=3.5,yend=3))+
   annotate("text",x = c(2.5),y = c(3.7),label = c("p = 0.0001"),family = "", fontface = 3, size=4)
...
boxplot_lit <- ggplot(subset(total.data,zone=="littoral"),aes(x=location,y=efflux))+
  ...
  geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=3,yend=2.5))+
   ...
   geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="SJP-Rish",y=4,yend=4.5))+
  geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="Salinas",y=4.5,yend=4.5))+
  geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=4.5,yend=4))+
...
boxplot_berm <- ggplot(subset(total.data,zone=="berm"),aes(x=location,y=efflux))+
  ...
  #geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=3,yend=2.5))+
   #annotate("text",x = c(2),y = c(3.2),label = c("p = 0.0493"),family = "", fontface = 3, size=4)+
   geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="SJP-Rish",y=2,yend=2.5))+
  geom_segment(data=annotation_df1,aes(x="SJP-Rish",xend="Salinas",y=2.5,yend=2.5))+
  geom_segment(data=annotation_df1,aes(x="Salinas",xend="Salinas",y=2.5,yend=2))+
   annotate("text",x = c(2.5),y = c(2.7),label = c("p = 0.0051"),family = "", fontface = 3, size=4)
...
boxplot_zones <- ggplot(subset(total.data),aes(x=zone,y=efflux))+
  ...
  theme(panel.grid.minor = element_blank(),panel.grid.major = element_blank(),panel.border = element_blank(),axis.line = element_line(color="black"))+
geom_segment(data=annotation_df2,aes(x="littoral",xend="littoral",y=3.1,yend=3.5))+
  geom_segment(data=annotation_df2,aes(x="littoral",xend="berm",y=3.5,yend=3.5))+
  geom_segment(data=annotation_df2,aes(x="berm",xend="berm",y=3.5,yend=3.1))+
   annotate("text",x = c(1.5),y = c(3.7),label = c("p < 0.001"),family = "", fontface = 3, size=4)+
   geom_segment(data=annotation_df2,aes(x="littoral",xend="littoral",y=4.1,yend=4.5))+
  geom_segment(data=annotation_df2,aes(x="littoral",xend="dunes",y=4.5,yend=4.5))+
  geom_segment(data=annotation_df2,aes(x="dunes",xend="dunes",y=4.5,yend=4.1))+
...
boxplot_tides <- ggplot(subset(total.data),aes(x=tide,y=efflux))+
  ...
  theme(panel.grid.minor = element_blank(),panel.grid.major = element_blank(),panel.border = element_blank(),axis.line = element_line(color="black"))+
geom_segment(data=annotation_df3,aes(x="2 < low",xend="2 < low",y=4.1,yend=4.5))+
  geom_segment(data=annotation_df3,aes(x="2 < low",xend="2 < high",y=4.5,yend=4.5))+
  geom_segment(data=annotation_df3,aes(x="2 < high",xend="2 < high",y=4.5,yend=4.1))+
   annotate("text",x = c(2.5),y = c(4.7),label = c("p = 0.033"),family = "", fontface = 3, size=4)+
   geom_segment(data=annotation_df3,aes(x="2 > low",xend="2 > low",y=1.5,yend=2.0))+
  geom_segment(data=annotation_df3,aes(x="2 > low",xend="2 < high",y=2,yend=2))+
  geom_segment(data=annotation_df3,aes(x="2 < high",xend="2 < high",y=2,yend=1.5))+
...
hatch14_sums$location <- factor(hatch14_sums$location, levels=c("EAFB","SJP-Rish","Salinas"),labels = c("EAFB-CSB","Rish","Salinas"))

hatch.plot2<-ggplot(hatch14_sums,aes(x=zone,y=total.success,fill=zone))+
  geom_col(stat = "identity")+
  geom_point(aes(x=zone,y=mean.eff*20),shape=15,size=3,color="navyblue")+
  geom_errorbar(aes(ymin=lower*20,ymax=upper*20))+
  geom_point(aes(y=tre.zone*20),color="salmon4",shape=15,size=3)+
...
sjp_zoom <- ggplot() +
  ...
  scale_color_manual(values = c("coral","darkolivegreen4","steelblue3"),name="Location",labels=c("Rish","Salinas","EAFB-CSB"))+
  ...
  theme(legend.title = element_text(colour="black", size=14,family = "Calibri", face="bold"), legend.text = element_text(size=12,family="Calibri")) +
...
total_map <- ggdraw() +
  draw_plot(sjp_zoom, 0,0,1,1) +
  draw_plot(florida_map, 0.75,0.70,0.25,0.25)
  #draw_grob(legend, .65, 0, .65, 1)
total_map



plot_grid(total_map,legend,rel_widths = c(2,0.4))
